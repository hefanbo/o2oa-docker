...
$ docker run --detach --name o2oa --restart unless-stopped --publish 80:80 --publish 20020:20020 --publish 20030:20030 --volume o2oa_config:/opt/o2server/config --volume <directory_for_local>:/opt/o2server/local o2oa
----
